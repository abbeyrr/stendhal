...
public class SummonAction extends AdministrationAction {
	...
	public void perform(final Player player, final RPAction action) {
        ...
        if ("handcart".equals(action.get(CREATURE))) {
        	final Handcart handcart = new Handcart();
        	handcart.setPosition(action.getInt(X), action.getInt(Y));
        	player.getZone().add(handcart);
  }
//        if ("chest".equals(action.get(CREATURE))) {
//        	final Chest chest = new Chest();
//        	chest.setPosition(action.getInt(X), action.getInt(Y));
//        	player.getZone().add(chest);
//  }
