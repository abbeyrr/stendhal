		...
		final SpeakerNPC npc = new SpeakerNPC("Sue") {
			...
			protected void createDialog() {
				class SpecialProducerBehaviour extends ProducerBehaviour {
					...
					@Override
					public boolean transactAgreedDeal(ItemParserResult res, final EventRaiser npc, final Player player,int c) {
						int amount = res.getAmount();
				...
				SeedSellerBehaviour seedSeller = new SeedSellerBehaviour();
				
				//get the pansy seed item from the SeedSellerBehaviour class
				final String liliaSeed = seedSeller.getAskedItem("lilia seed", new Player(new SpeakerNPC("Sue"))).getName();
				//get the pansy seed item from the SeedSellerBehaviour class
				final String pansySeed = seedSeller.getAskedItem("pansy seed", new Player(new SpeakerNPC("Sue"))).getName();
				//get the daisies seed item from the SeedSellerBehaviour class
				final String daisiesSeed = seedSeller.getAskedItem("daisies seed", new Player(new SpeakerNPC("Sue"))).getName();
				//get the zantedeschia bulb seed item from the SeedSellerBehaviour class
				final String zantBulb= seedSeller.getAskedItem("zantedeschia bulb", new Player(new SpeakerNPC("Sue"))).getName();
				
				
			
				// npc will have seeds available to sell to the player for between 10 to 20 coins each, depending on the seeds asked
				
				//if user asks for shovel, sell the shovel to user for 20 coins
				add(ConversationStates.ATTENDING, 
						Arrays.asList("shovel"), 
						new AndCondition(new GreetingMatchesNameCondition(getName()), new PlayerHasItemWithHimCondition("money", 20)),
						ConversationStates.ATTENDING, 
						"Here you are.", 
						new MultipleActions(new DropItemAction("money", 20), new EquipItemAction("shovel", 1, true)));
				
				add(ConversationStates.ATTENDING, 
						Arrays.asList("seeds", "seed"), 
						null, 
						ConversationStates.ATTENDING, 
						"Tell me which seed would you like to buy", 
						null);
				
				//player asking to buy lilia seed
				add(ConversationStates.ATTENDING, 
						Arrays.asList("lilia seed","lilia seeds"), 
						new AndCondition(new GreetingMatchesNameCondition(getName()), new PlayerHasItemWithHimCondition("money", 10)),
						ConversationStates.ATTENDING, 
						"Here you are.", 
						new MultipleActions(new DropItemAction("money", 10), new EquipItemAction(
						liliaSeed, 1, true)));
				//player asking to buy daisies seed
				add(ConversationStates.ATTENDING, 
						Arrays.asList("daisies seed","daisie seeds"), 
						new AndCondition(new GreetingMatchesNameCondition(getName()), new PlayerHasItemWithHimCondition("money", 20)),
						ConversationStates.ATTENDING, 
						"Here you are.", 
						new MultipleActions(new DropItemAction("money", 20), new EquipItemAction(
						daisiesSeed, 1, true)));
				//player asking to buy zantedeschia bulbs
				add(ConversationStates.ATTENDING, 
						Arrays.asList("zantedeschia bulb","zantedeschia bulbs"), 
						new AndCondition(new GreetingMatchesNameCondition(getName()), new PlayerHasItemWithHimCondition("money", 15)),
						ConversationStates.ATTENDING, 
						"Here you are.", 
						new MultipleActions(new DropItemAction("money", 15), new EquipItemAction(
						zantBulb, 1, true)));
				//player asking to buy pansy seed
				add(ConversationStates.ATTENDING, 
						Arrays.asList("pansy seed","pansy seeds"), 
						new AndCondition(new GreetingMatchesNameCondition(getName()), new PlayerHasItemWithHimCondition("money", 10)),
						ConversationStates.ATTENDING, 
						"Here you are.", 
						new MultipleActions(new DropItemAction("money", 10), new EquipItemAction(
				...
				// if the player doesn't have enough coins for shovel and seed items, the npc will respond accordingly.
				add(ConversationStates.ATTENDING, 
						Arrays.asList("lilia seed","pansy seed", "lilia seeds", "pansy seeds"), 
				...
				add(ConversationStates.ATTENDING, 
						Arrays.asList("zantedeschia bulb","zantedeschia bulbs"), 
						new NotCondition(new PlayerHasItemWithHimCondition("money", 15)),
						ConversationStates.ATTENDING, 
						"Sorry, but you don't have enough money.",
						null);
				
				add(ConversationStates.ATTENDING, 
						Arrays.asList("shovel","daisies seed","daisie seeds"), 
						new NotCondition(new PlayerHasItemWithHimCondition("money", 20)),
						ConversationStates.ATTENDING, 
						"Sorry, but you don't have enough money.",
						null);
