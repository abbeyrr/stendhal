...
public class OutfitChangerAdder {
	...
	public void addOutfitChanger(final SpeakerNPC npc,
				...
				new BehaviourAction(outfitBehaviour, action, "offer") {
					...
					public void fireRequestOK(final ItemParserResult res, Player player, Sentence sentence, EventRaiser raiser) {
						...
						raiser.say("To " + action + " a " + res.getChosenItemName() + " will cost " + price
								+ ". Do you want to " + action + " it?"+"Choose number to select which one you want");
		...
		engine.add(ConversationStates.BUY_PRICE_OFFERED,
				ConversationPhrases.ITEMLIST, null,
				...
				null, new ChatAction() {
					...
					public void fire(final Player player, final Sentence sentence,
						...
						if (outfitBehaviour.transactAgreedDeal(currentBehavRes, npc, player,1)) {
							if (canReturn) {
		...
		engine.add(ConversationStates.BUY_PRICE_OFFERED,
				ConversationPhrases.ITEMLIST2, null,
				false, ConversationStates.ATTENDING,
				null, new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence,
						...
						if (outfitBehaviour.transactAgreedDeal(currentBehavRes, npc, player,2)) {
							if (canReturn) {
								npc.say(getReturnPhrase());
								// -1 is also the public static final int NEVER_WEARS_OFF = -1;
								// but it doesn't recognise it here ...
		...
		engine.add(ConversationStates.BUY_PRICE_OFFERED,
				ConversationPhrases.ITEMLIST3, null,
				false, ConversationStates.ATTENDING,
				null, new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence,
						...
						if (outfitBehaviour.transactAgreedDeal(currentBehavRes, npc, player,3)) {
							if (canReturn) {
								npc.say(getReturnPhrase());
								// -1 is also the public static final int NEVER_WEARS_OFF = -1;
								// but it doesn't recognise it here ...
		...
		engine.add(ConversationStates.BUY_PRICE_OFFERED,
				ConversationPhrases.ITEMLIST4, null,
				false, ConversationStates.ATTENDING,
				null, new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence,
						...
						if (outfitBehaviour.transactAgreedDeal(currentBehavRes, npc, player,4)) {
							if (canReturn) {
								npc.say(getReturnPhrase());
								// -1 is also the public static final int NEVER_WEARS_OFF = -1;
								// but it doesn't recognise it here ...
		...
		engine.add(ConversationStates.BUY_PRICE_OFFERED,
				ConversationPhrases.ITEMLIST5, null,
				false, ConversationStates.ATTENDING,
				null, new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence,
						...
						if (outfitBehaviour.transactAgreedDeal(currentBehavRes, npc, player,5)) {
							if (canReturn) {
								npc.say(getReturnPhrase());
								// -1 is also the public static final int NEVER_WEARS_OFF = -1;
								// but it doesn't recognise it here ...
		...
		engine.add(ConversationStates.BUY_PRICE_OFFERED,
				ConversationPhrases.ITEMLIST6, null,
				false, ConversationStates.ATTENDING,
				null, new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence,
						...
						if (outfitBehaviour.transactAgreedDeal(currentBehavRes, npc, player,6)) {
							if (canReturn) {
								npc.say(getReturnPhrase());
								// -1 is also the public static final int NEVER_WEARS_OFF = -1;
								// but it doesn't recognise it here ...
