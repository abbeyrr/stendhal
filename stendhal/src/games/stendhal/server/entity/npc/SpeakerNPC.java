...
//				if (dx*dx + dy*dy < range*range) { // optionally we could check a circular area
	...
	public void addChest(final String helpDescription) {
		addReply(ConversationPhrases.BANKCHEST, helpDescription);
		TellerAccess.AccessConfirm();
	}
	
	//public void addMore(final String helpDescription) {
	//	addReply(ConversationPhrases.MOREHELP_MESSAGES, helpDescription);
	//}
