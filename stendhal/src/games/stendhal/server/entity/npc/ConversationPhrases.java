...
public class ConversationPhrases {
	...
	public static final List<String> BANKCHEST = Arrays.asList("bank chest", "personal bank chest");
	public static final String ITEMLIST = "1";

	public static final String ITEMLIST2 = "2";

	public static final String ITEMLIST3 = "3";
	public static final String ITEMLIST4 = "4";
	public static final String ITEMLIST5 = "5";
	public static final String ITEMLIST6 = "6";
