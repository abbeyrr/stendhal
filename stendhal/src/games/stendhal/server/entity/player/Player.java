	...
	public boolean isZoneChangeAllowed() {
		...
		if (sheep != null) {
			if (squaredDistance(sheep) > 7 * 7) {
				sendPrivateText(NotificationType.SERVER, "You can't travel because your sheep is too far away!");
				return false;
			}
		}
		...
		if (pet != null) {
			if (squaredDistance(pet) > 7 * 7) {
				sendPrivateText(NotificationType.SERVER, "You can't travel because your pet is too far away!");
				return false;
			}
		}
