...
public class MarriageTest {
	...
	public void testBuySuitForGroom() {
		...
		en.step(player, "wear");
		assertEquals("To wear a suit will cost 50. Do you want to wear it?"+"Choose number to select which one you want", getReply(npc));
	...
	public void testBuyGownForBride() {
		...
		assertEquals("To wear a gown will cost 100. Do you want to wear it?"+"Choose number to select which one you want", getReply(npc));
		en.step(player2, "1");
		assertEquals("Thanks, and please don't forget to #return it when you don't need it anymore!", getReply(npc));
		en.step(player2, "bye");
